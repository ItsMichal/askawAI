  ...
  constructor(props: SearchBarProps) {
    ...
    this.state = {
      ...
      suggestions: [
        ...
        { id: 17, name: "Biochemistry" },
        { id: 18, name: "Volcanos" },
        { id: 19, name: "Literature" },
        { id: 20, name: "Civil War" },
        { id: 21, name: "Respiratory System" },
        { id: 22, name: "Photosynthesis" },
        { id: 23, name: "Anthropology" },
        { id: 24, name: "Artificial Intelligence" },
        { id: 25, name: "Ecosystems" },
        { id: 26, name: "Film" },
        { id: 27, name: "Evaporation" },
        { id: 28, name: "Polish History" },
        { id: 29, name: "Declaration of Independence" },
        { id: 30, name: "The Great Gatsby" },
        { id: 31, name: "Physics" },
        { id: 32, name: "Cells" },
        { id: 33, name: "United States of America" },
      ],
    }
